...
extends Migration
{
    protected $table;  //storing Blueprint
    public function getTable()      //проверяем выбрана ли таблица если не выбрана то 
    {
        if ($this->table == null)
        {
            throw new Exception("Table not set.");  //выплевываем ошибку 
        }
        return $this->table;        //rc
    }
    public function setTable(Blueprint $table)  //выбираем таблицу
    {
        $this->table = $table;
        return $this;
    }
